...
export default function ClubDetails() {
    ...
    const clubData = {
        name: 'IGNITE STARTUPS',
        memberCount: '30',
        leader: 'Tariq Hameed',
        meetingDay: 'Tuesday',
        meetingTime: '21:00',
        description: 'Welcome to the Ignite Startups Club! Our mission is to spark a community of creative entrepreneurs and visionary innovators passionate about turning ideas into impactful ventures. Whether you\'re an experienced founder or just starting your entrepreneurial journey, our club offers the perfect environment to develop your business acumen and refine your startup strategies. Take part in startup challenges, pitch workshops, and networking sessions on business models, market strategies, and funding. Collaborate with like-minded peers, gain mentorship from industry leaders, and join a vibrant community that celebrates innovation, risk-taking, and continuous growth.'
    }
