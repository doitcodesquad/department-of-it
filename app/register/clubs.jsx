      ...
      <div className="md:px-8 px-0">
        ...
        <div className="max-w-full sm:max-w-3xl mx-auto py-3 sm:py-9 px-2 sm:px-6 bg-orange-50 border-4 border-black relative">
              ...
              <div
                ...
                className={`border-2 border-black cursor-pointer transition-all duration-300 ${
                  selectedOptions.includes(option.name)
                    ? 'bg-sky-50 border-l-8 border-l-accent'
                    : 'bg-emerald-50'
                }`}
              >
                <div className="h-24 flex flex-row gap-3 items-center md:py-1">
                  <div className="ms-1 text-3xl md:text-4xl">
                    <Icon icon={option.icon} />
                  </div>
                  <div className="flex flex-col">
                    <div className="text-lg md:text-xl">{option.name}</div>
                    <div>
                      <p className="text-sm md:text-md opacity-80 line-clamp-3">
                        {option.description}
                      </p>
                    </div>
                  </div>
          ...
          <div className="flex md:flex-nowrap flex-wrap w-full justify-between items-center">
            <div className="my-2 me-2 text-[10px] sm:text-sm text-gray-600 order-1 sm:order-none">
