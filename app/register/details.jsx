          ...
          <div className="w-full mb-10">
            <div className="relative">
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 h-24 rounded-sm placeholder-transparent text-secondary-100 bg-emerald-50 text-sm border border-black focus:outline-none focus:border-2 peer transition-border"
                placeholder=" "
              />
              <label htmlFor="additionalInfo" className="floating-placeholder">
              Any other skills or contributions you would like to bring to the club?
              </label>
            </div>
          </div>
          <div className="w-full mb-10">
            <div className="relative">
              <textarea
                ...
                placeholder=" "
              />
              <label htmlFor="reasonToJoin" className="floating-placeholder">
                Why do you want to join CODESQUAD?
              </label>
            </div>
          </div>
